...
class Location(models.Model):
    ...
    memo = models.CharField(
        verbose_name='メモ', max_length=255, default='', blank=True)
...
class WeatherData(models.Model):
    ...
    location = models.ForeignKey(
        Location, verbose_name='ロケーション', on_delete=models.PROTECT)
    data_datetime = models.DateTimeField(verbose_name='データ日時', default=dt.strptime(
        '2001-01-01 00:00:00', '%Y-%m-%d %H:%M:%S'))
